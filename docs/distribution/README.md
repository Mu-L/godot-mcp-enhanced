...
中文版:
```markdown
- **Godot 引擎(增强版)**:[wgt19861219/godot-mcp-enhanced](https://github.com/wgt19861219/godot-mcp-enhanced) — 免费开源的 Godot MCP 服务器,39 个工具覆盖场景/脚本/UI/动画/物理/粒子/导航/音频/测试/导出,三层架构 + 系统化安全防护。Godot 4.5–4.7 兼容矩阵。
```
英文版:
```markdown
- **Godot (Enhanced)**: [wgt19861219/godot-mcp-enhanced](https://github.com/wgt19861219/godot-mcp-enhanced) — Free, open-source MCP server for the Godot engine. 39 tools (...), 3-layer architecture (...), systematic security guards (...), Godot 4.5–4.7 compat matrix.
```
</details>
