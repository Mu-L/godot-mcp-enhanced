...
---
<!-- AUTO-GENERATED by scripts/gen-tool-docs.mjs from capability-matrix.json v0.32.12. DO NOT edit manually; re-run npm run gen:tool-docs after tool changes. -->
