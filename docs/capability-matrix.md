...
- token 预算：tools/list ≈ 104988B / ~26247 tokens（description 15962B / schema 89026B，schema 占 85%）
...
## token 预算 TOP 5
- `ui` (ui): desc 709B / schema 10927B / total 11636B
- `game` (bridge): desc 393B / schema 7557B / total 7950B
