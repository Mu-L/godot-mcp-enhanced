...
godot-mcp-enhanced 提供 33 个 MCP 工具（199 个 action，权威数据见 docs/capability-matrix.md，由 `npm run build-matrix` 生成），通过三层架构操作 Godot：
