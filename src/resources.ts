...
2. Run the game — the bridge starts a TCP server in the 9081-9090 range (randomized start candidate, auto-increments when occupied)
...
- Check ports 9081-9090 are not blocked/reserved (start candidate is randomized within the range; bridge auto-avoids occupied ones)
