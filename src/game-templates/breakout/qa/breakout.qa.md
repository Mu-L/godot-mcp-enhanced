...
```qa-spec
{
  ...
  "steps": [
    ...
    { "type": "step_until",
      "params": { "conditions": [ { "path": "/root/Main/GameBreakout", "property": "frames_simulated", "op": ">=", "value": 200 } ], "max_frames": 260 },
      "label": "模拟 200 帧" },
    { "type": "assert", "assertion": "node_state",
      "params": { "path": "/root/Main/GameBreakout", "expect": { "lives": 3 }, "tolerance": 0 },
      "label": "AC-1 生命未损(200 帧内)" },
    { "type": "assert", "assertion": "node_state",
      "params": { "path": "/root/Main/GameBreakout", "expect": { "game_over": false }, "tolerance": 0 },
      "label": "AC 未结束" },
